...
<html style="font-size: 16px;" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/surat-detail.css">
    ...
    <body class="u-body u-xl-mode" data-lang="en">
            ...
            <div class="u-clearfix u-sheet u-sheet-1">
              <div class="container mt-4">
                <div class="row">
                    ...
                    <!-- end dari informasi surat -->

                    <!-- isi dari surat (detail surat) -->
        ...
        <script type="text/javascript" src="assets/js/surat-detail.js"></script>
    </body>
</html>
